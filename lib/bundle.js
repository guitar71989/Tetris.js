	...
	var View = function () {
	  ...
	  _createClass(View, [{
	    ...
	    value: function startGame() {
	      ...
	      document.addEventListener('keydown', this.addKeydownListeners);
	    }
	  }, {
	    key: 'gravity',
	        ...
	        if (!this.currentPiece.move("down")) {
	          (function () {
	            ...
	            $cinnaDOM('#playagain').on('click', function () {
	              ...
	              document.removeEventListener('keydown', view.addKeydownListeners);
	    ...
	    value: function endGame() {
	      ...
	      document.removeEventListener('keydown', this.addKeydownListeners);
